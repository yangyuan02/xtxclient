(function(){
    ...
    UM.registerWidget('link', {
        tpl: "<style type=\"text/css\">" +
            ".edui-dialog-link .edui-link-table{font-size: 12px;margin: 10px;line-height: 50px}" +
            ".edui-dialog-link .edui-link-txt{width:300px;height:38px;line-height:38px;border:1px solid #eee;}" +
            "</style>" +
